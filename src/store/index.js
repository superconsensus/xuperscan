...
export default new Vuex.Store({
  state: {
    local_url_list: [
      { name: 'XuperChain', url: 'http://43.128.73.205:8088' },
    ],
    add_local_url_list: [],
    baseURL_list_value:  window.localStorage.getItem("value_url")?JSON.parse(window.localStorage.getItem("value_url")):[{ name: '超级链', url: 'http://43.128.73.205:8088' }],
    ListeningToThe:0
  },
  mutations: {
